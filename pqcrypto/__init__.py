import os
from ctypes import cdll, CDLL, c_char_p, c_int, c_ulonglong, POINTER, byref, create_string_buffer, util

lib = cdll.LoadLibrary(util.find_library('pqcrypto') or util.find_library('libpqcrypto'))
if not lib._name:
    raise ValueError('Unable to find libpqcrypto')
